# 週0後半: 環境構築 — 開発できるPCを用意する（Windows + WSL2 前提）

> 📕 **先に [week00-it-basics/README.md](../week00-it-basics/README.md)（IT基礎の座学）を読み終えてからここに来てください。** この手順書には「ターミナル」「ファイルパス」「OS」などの言葉が出てきます。それらの意味は座学の章で説明済みなので、分からない言葉が出たらそちらに戻って確認できます。
...
全部✅になったら、[week1-java-basics/README.md](../week1-java-basics/README.md) へ進んでください。
