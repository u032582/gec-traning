...
> 課題00で「`static` だけは今はおまじないにしておく」と予告しました（[00-first-run.md のコラム](00-first-run.md#コラム-public-static-void-mainstring-args-の正体最初は写すだけでok)）。クラスとインスタンスの違いを学んだ**今なら**、その正体が分かります。ここで回収しましょう。
